...
DATA = {
    ...
    "كلية الإعلام": {
        "السنة الأولى": {
            "فصل الاول": ["مدخل الى وسائل الإعلام - إدارة المؤسسات الإعلامية", "مدخل الى الصورة والسينما ", " مادة إعلامية باللغة الانكليزية","مدخل الى الصحافة","الإعلان - مبادئ وإدارة","العلاقات العامة - مبادئ وإدارة","مهارات الحاسوب","التعليم الإلكتروني"],
            "فصل الثاني": ["مدخل الى التحرير الإعلامي ", "مناهج البحث الإعلامي ", "مادة إعلامية باللغة الانكليزية 2 ","الاتصال والمجتمع","الأدب والنقد واللغة الإعلامية","مدخل الى الإذاعة والتلفزيون"]
        },
        "السنة الثانية": {
            "فصل الاول": ["نظريات الإعلام والاتصال" , " التشريعات الإعلامية وأخلاقيات المهنة ", " مادة إعلامية باللغة الانكليزية 3"," الرأي العام وطرق قياسه"," مدخل الى علم الاجتماع الإعلامي","  الاتصال التنظيمي","قضايا راهنة "],
            "فصل الثاني": [" أساليب الإقناع والتسويق الاجتماعي", " التخطيط الإعلامي", "اقتصاد الإعلام والمعرفة "," مصادر المعلومات والتوثيق الإعلامي"," الإعلام والاتصال الإلكتروني","القيادة الإدارية ","الإعلام والاتصال الدولي"]
        },
        "السنة الثالثة": {
            "الإذاعة والتلفزيون":{ 
                "فصل الاول": ["التقديم والإلقاء الإذاعي والتلفزيوني" , "البرامج الاخبارية في الإذاعة التلفزيون", "إعداد البرامج الإذاعية","الإعلام الإذاعي والتلفزيوني المتخصص","إدارة الإبداع والابتكار","حقوق الملكية الفكرية"],
            "فصل الثاني": ["اساليب تحليل الصورة", "التحرير الاستقصائي", "الوسائط المتعددة","تشريعات اعلامية","البرامج الحوارية والإذاعية والتلفزيونية","إدارة المؤسسات الإعلامية"]
            },
            "اعلام الكتروني ":{ 
                "فصل الاول": ["حقوق الملكية الفكرية","إدارة الإبداع والابتكار","مهارات الإقناع بالوسائل الالكترونية","سلوك المستهلك","الصحافة الالكترونية والنشر الالكتروني","أسس إدارة الأعمال"],
            "فصل الثاني": ["اساليب تحليل الصورة", "التحرير الاستقصائي", "الوسائط المتعددة","تشريعات اعلامية","صحافة المواطن","وسائل الاتصال الالكترونية"]
            },
            "العلاقات العامة":{ 
                "فصل الاول": [ "حقوق الملكية الفكرية", "العلاقات الإعلامية والإعلانية","مبادئ التسويق","سلوك المستهلك","العلاقات العامة والأزمات","كتابة وتحرير الأخبار 1"],
            "فصل الثاني": ["أساليب  تحليل الصورة", "مهارات العلاقات العامة", "علم الاقتصاد","السلوك التنظيمي","سيكولوجيا الإعلان","العلاقات العامة الدولية"]
            },
            "الإعلان":{ 
                "فصل الاول": [" مهارات الإقناع بالوسائل الإلكترونية" ,"تخطيط المحتوى الإعلاني","سلوك المستهلك","مبادئ التسويق","إدارة الإبداع والابتكار","حقوق الملكية الفكرية"],
            "فصل الثاني": ["استراتيحيات وسياسات التسويق", "سيكولوجيا الإعلان", "تشريعات إعلامية","علم الاقتصاد","مهارات العلاقات العامة","أساليب تحليل الصورة"]
            },
        ...
        "السنة الرابعة": {
            "الإذاعة والتلفزيون":{ 
                 "فصل الاول": ["السيناريو والدراما","الإعلان الإذاعي والتلفزيوني","تكنلوجيا الإعلام والتعليم","الإنتاج الإذاعي والتلفزيوني","كتابة وإعداد التقارير الإخبارية","مجتمع المعلومات"],
            "فصل الثاني": ["مشروع التخرج", "كتابة تلفزيونية مستوى متقدم", "التصميم الجرافيكي","الأفلام الوثائقية","تحرير مواد الرأي ","الإخراج الإذاعي والتلفزيوني"]
            },
            "اعلام الكتروني ":{ 
               "فصل الاول": ["مجتمع المعلومات", "المقابلة الإعلامية", "تكوين صفحة الويب","تكنولوجيا الإعلام والتعليم","إنتاج وإخراج الصحف","التسويق الإلكتروني"],
            "فصل الثاني": [ "أساليب وأصول وتقنيات النشر", "الحديث والتحقيق التلفزيوني","الأفلام الوثائقية","التصميم الجرافيكي","تحرير مواد الرأي " ]
            },
            "العلاقات العامة":{ 
                "فصل الاول": ["مجتمع المعلومات" , "العلاقات العامة والتفاوض", "تسويق الخدمات","التسويق الإلكتروني","الانترنت والمجتمع","السيناريو والدراما"],
            "فصل الثاني": ["مشروع التخرج", "الكتابة للعلاقات العامة", "إدارة العلامة التجارية","التحليل الاقتصادي","حملات العلاقات العامة","أسااليب وأصول وتقنيات النشر"]
            },
            "الإعلان":{ 
                "فصل الاول": [ "مجتمع المعلومات", "المقابلة الإعلامية","تسويق الخدمات","تصميم الإعلان","الإعلان الاذاعي والتلفزيوني","السيناريو والدراما"],
            "فصل الثاني": [ "التصميم الجرافيكي", "الاتصال التسويقي","التحليل الاقتصادي","إدارة العلامة التجارية","علم الجمال"]
            },
